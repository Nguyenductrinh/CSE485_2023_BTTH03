-- a
SELECT * FROM baiviet bv JOIN theloai tl ON bv.ma_tloai = tl.ma_tloai WHERE tl.ten_tloai = "Nhạc trữ tình";

-- b
SELECT * FROM baiviet bv JOIN tacgia tg ON bv.ma_tgia = tg.ma_tgia WHERE tg.ten_tgia = "Nhacvietplus";
