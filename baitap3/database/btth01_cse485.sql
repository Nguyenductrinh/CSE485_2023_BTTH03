...
CREATE TABLE `tacgia` (
  ...
  `hinh_tgia` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `baiviet`
  ...
  ADD KEY `Test1` (`ma_tloai`),
  ADD KEY `Test2` (`ma_tgia`);
...
--
ALTER TABLE `baiviet`
  ADD CONSTRAINT `Test1` FOREIGN KEY (`ma_tloai`) REFERENCES `theloai` (`ma_tloai`),
  ADD CONSTRAINT `Test2` FOREIGN KEY (`ma_tgia`) REFERENCES `tacgia` (`ma_tgia`);
COMMIT;
